...
namespace TelerikMvcApp1.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly Data.eCurriculum2010.eCurriculum2010Entities1 eCurrEnt = new Data.eCurriculum2010.eCurriculum2010Entities1();
        ...
        public JsonResult CascadingGetStudents(string classYear, string society)
        {
            ...
            //    //var phdloaByYear = canEnt.v_studentsAll
            //    //    .Where(c => c.campuscode == "cwru")
            //    //    .Where(c => c.Prog_status == "LA" || (c.Prog_status == "AC" && c.reduced_fee == "y"))
            //    //    .OrderBy(c => c.Emplid)
            //    //    .Select(c => c.Emplid)
            ...
            //    //var phdloaInYear = phdloaByYear
            //    //    .Select(c => Int32.Parse(c))
            //    //    .ToList();

            //    //var phdByYear = regEnt.vw_Matri_Grad_Dates
            //    //    .Where(c => phdloaByYear.Contains((c.Emplid)))
            //    //    .Where(c => c.campuscode == "cwru")
            //    //    .Where(c => c.Prog_status== "ac" && c.mstpprog_status == "AC")                
            //    //    .Select(c=> c.Emplid)
            //    //    .ToList();

            //    //var phdInYear = phdByYear
            //    //    .Select(c => Int32.Parse(c))
            //    //    .ToList();                               

            //    //var phdBySociety = regEnt.vw_Matri_Grad_Dates
            //    //    .Where(x => x.advisor_society.Contains(society))
            //    //    .Where(x => phdByYear.Contains(x.Emplid))
            //    //    .Select(x => x.Emplid)
            //    //    .ToList();                

            //    //var phdInSociety = phdBySociety
            //    //    .Select(c => Int32.Parse(c))
            //    //    .ToList();

            //    //var phdPersonalInfo = regEnt.Personals
            //    //    .Where(x => phdBySociety.Contains(x.Emplid) && (phdByYear.Contains(x.Emplid)) && (phdloaByYear.Contains(x.Emplid)))
            //    //    .OrderBy(x => x.Last_Name)
            //    //    .Select(x => new { Name = x.Last_Name + ", " + x.First_Name })
            //    //    .ToList();

            //    //return Json(phdPersonalInfo, JsonRequestBehavior.AllowGet);
